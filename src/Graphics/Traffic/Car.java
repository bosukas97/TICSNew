...
public class Car extends Thread{
    ...
    private static Integer CounterN1=0;
    private static Integer CounterN23=0;
    private static Integer CounterS1=0;
    private static Integer CounterS23=0;
    private static Integer CounterW1=0;
    private static Integer CounterW23=0;
    private static Integer CounterE1=0;
    private static Integer CounterE23=0;
...
//        System.out.println(side);
        ...
        setCounters(side,ground.x,ground.y);
...
//        System.out.println(side);
    ...
    if(side.equals(Direction.WEST)) {
        if (y == 265) {
            CounterW1++;
//            System.out.println("Incrementing West");
    ...
    if(side.equals(Direction.SOUTH)){
        if(x==265){
//            System.out.println("Incrementing South");
            CounterS1++;
        }
        else{
            CounterS23++;
    ...
    public static Integer[] getCounters(){
            Integer[] allCounters = new Integer[8];
            allCounters[0] = CounterN1;
            allCounters[1] = CounterN23;
            allCounters[2] = CounterS1;
            allCounters[3] = CounterS23;
            allCounters[4] = CounterE1;
            allCounters[5] = CounterE23;
            allCounters[6] = CounterW1;
            allCounters[7] = CounterW23;
            return allCounters;
    }
